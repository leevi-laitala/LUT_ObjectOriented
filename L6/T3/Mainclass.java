...
class Mainclass
{
    ...
    private static void deposit()
    {
        ...
        //acc.deposit(amount);
        System.out.println(String.format("Depositing to the account: %s the amount %d", id, amount));
    }
    ...
    private static void withdraw()
    {
        ...
        System.out.println(String.format("Withdrawing from the account: %s the amount %d", id, amount));
    }
    ...
    private static void create()
    {
        ...
        System.out.println(String.format("Adding to bank: %s,%d", id, funds));
    }
    ...
    private static void createCredit()
    {
        ...
        System.out.println(String.format("Adding to bank: %s,%d,%d", id, funds, credit));
    }

    private static void info()
    {
        String id = getID("Give the account number of the account to print information from");
        System.out.println(String.format("Searching for account: %s", id));
    }
